...
schema_view = get_schema_view(
    openapi.Info(
        ...
        default_version='v1',
        contact=openapi.Contact(email="info@cvisionai.com"),
...
urlpatterns += [
    ...
    url(r'^rest(?P<format>\.json|\.yaml)$', schema_view.without_ui(cache_timeout=0)),
    url(r'^rest/$', schema_view.with_ui('swagger', cache_timeout=0)),
